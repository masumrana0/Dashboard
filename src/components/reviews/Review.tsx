...
const Review: React.FC<{ review: IReview }> = ({ review }) => {
  ...
  return (
    <div>
      <div className="bg-white rounded-lg shadow-lg h-[12rem] w-[17rem]  lg:w-[25rem] p-4 relative">
        ...
        <div className="flex items-center gap-2 ">
          ...
          <div>
            ...
            <p className="text-[12px] text-gray-400 tracking-tighter font-semibold ">
              CEO OF NORJA
            </p>
          </div>
        </div>
        <p className="text-sm py-4 text-gray-600">{review.review}</p>
        <div className="flex items-center justify-between ">
          ...
          <div className="">
            <p className="text-gray-500 text-xs font-bold">2 days ago</p>
